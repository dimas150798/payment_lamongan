    ...
    <main>
        ...
        <div class="menuatas">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-6">
                    <i class="fa fa-list"></i> <b class="textmenuatas">Tambah Sales</b>
                </div>
            ...
            <div class="card mb-3 mt-3">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <form method="POST" action="<?php echo base_url('admin/DataSales/C_TambahSales/TambahSalesSave') ?>">

                            <div class="row justify-content-center">
                                <div class="col-sm-4 mt-3">
                                    <label for="name" class="form-label" style="font-weight: bold;"> Nama : <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="name" value="" placeholder="Masukkan nama...">
                                    <div class="bg-danger">
                                ...
                                <div class="col-sm-4 mt-3">
                                    ...
                                    <input type="number" class="form-control" name="phone" value="" placeholder="Masukkan telephone...">
                                    <div class="bg-danger">
