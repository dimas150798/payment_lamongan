                            ...
                            <form method="POST" action="<?php echo base_url('admin/BelumLunas/C_WA_Tagihan/KirimWAAksi') ?>">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" class="form-control bg-warning fw-bold" name="tanggal_penagihan" value=" <?php echo $data['tanggal'] ?>" readonly>
                                        <input type="hidden" class="form-control bg-warning fw-bold" name="tahun_penagihan" value=" <?php echo date("Y"); ?>" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-secondary"><i class="bi bi-bookmarks-fill text-white"></i></span>
                                            <input type="text" class="form-control bg-warning fw-bold" name="bulan_penagihan" value="<?php echo $months[$bulan] ?>" placeholder="Data Kosong" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-lg-4 mt-4">
