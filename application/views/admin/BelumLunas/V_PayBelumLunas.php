                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold fs-6 bg-warning" name="order_id" id="order_id" value="<?php echo $this->M_BelumLunas->invoice() ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold fs-6 bg-warning" name="name" id="name" value="<?php echo $data['name'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-secondary"><i class="bi bi-person-bounding-box text-white"></i></span>
                                            <input type="text" class="form-control fw-bold fs-6 bg-warning" name="name_pppoe" id="name_pppoe" value="<?php echo $data['name_pppoe'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold fs-6 bg-warning" name="" id="" value="<?php echo $data['nama_paket'] ?> / Rp. <?php echo number_format($data['harga_paket'], 0, ',', '.') ?> + PPN" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="datetime" class="form-control fw-bold fs-6 bg-warning" name="transaction_time" id="transaction_time" value="<?php echo $Tanggal ?>" readonly>
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="biaya_admin" name="biaya_admin" class="form-control fw-bold fs-6" required>
