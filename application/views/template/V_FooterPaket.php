...
<script>
	$(document).ready(function() {
		$('#mytable').DataTable({
			...
			"pagingType": 'numbers',
			"ajax": {
				"url": "<?= base_url('admin/DataPaket/C_DataPaket/GetDataAjax'); ?>",
			},
...
<!-- Delete Paket -->
<script>
	function DeletePaket(parameter_id) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?php echo site_url('admin/DataPaket/C_DeletePaket/DeletePaket') ?>/" + parameter_id;
			}
		})
	}
</script>
...
<!-- Edit Data Paket -->
<script>
	function EditPaket(parameter_id) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?php echo site_url('admin/DataPaket/C_EditPaket/EditPaket') ?>/" + parameter_id;
			}
		})
	}
</script>
